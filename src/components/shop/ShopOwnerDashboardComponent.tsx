/**
 * ShopOwner Dashboard Component
 *
 * React component for ShopOwner dashboard with Active Orders widget and Parts Search.
 *
 * @component components/shop/ShopOwnerDashboardComponent
 * @version 0.1.0
 */
...
export default function ShopOwnerDashboardComponent({
  suppliers,
  organizationId,
  userId,
  orderStats,
}: Props) {
  // Default values for orderStats to prevent undefined errors
  ...
  // Default values for suppliers to prevent undefined errors
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-body-md text-neutral-400">
          Order parts and track your deliveries
        </p>
      </div>

      {/* Active Orders Summary Widget */}
        ...
        <Card>
          <CardContent className="py-6">
            <div className="text-center">
              ...
              <p className="text-label-sm text-neutral-500">En Route</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-6">
            <div className="text-center">
              <p className="text-headline-lg font-bold text-warning-500">
                {stats.pending}
              </p>
              <p className="text-label-sm text-neutral-500">Pending</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-6">
            <div className="text-center">
              ...
              <p className="text-label-sm text-neutral-500">Delivered Today</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-6">
            <div className="text-center">
              ...
              <p className="text-label-sm text-neutral-500">This Month</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mb-6">
        ...
        {/* Search Helper Card */}
        <Card className="mb-4 bg-info-50 border-info-200">
        ...
        {results.length > 0 && (
          <div>
            <h3 className="text-headline-md font-semibold text-neutral-600 mb-4">
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-body-md text-neutral-500">
                We&apos;ll search across {suppliersList.length} local suppliers
              </p>
            </CardContent>
          </Card>
        )}
